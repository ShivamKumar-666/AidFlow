...
class CreateDonationView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        try:
            ...
            explainer.explain(ml_input, top_n=3)
            explainer.explain_to_text(ml_input)
...
class ListDonationsView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        if user.role == "donor":
            ...
            return Donation.objects.filter(Q(status="pending") | Q(recipient=user)).order_by("-created_at")
