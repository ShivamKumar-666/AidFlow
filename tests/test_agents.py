...
class TestIntakeAgent:
    ...
    def test_intake_agent_success(self, mock_get_explainer, mock_get_predictor):
        ...
        mock_get_explainer.return_value.explain.return_value = [
            {"feature": "storage_condition_refrigerated", "impact": 0.5, "direction": "positive"}
        ]
        ...
        state = {
            ...
            "latitude": None,
            "longitude": None,
            "storage_time_hours": 4.0,
            "time_since_cooking_hours": 2.0,
...
class TestVerificationAgent:
    ...
    def test_verify_fails_old_food(self):
        ...
        state = {
            "quantity_kg": 5,
            "storage_time_hours": 30,
            "time_since_cooking_hours": 20,
            "food_type": "Vegetarian",
            "storage_condition": "refrigerated",
            "freshness_score": 30,
            "smell": "neutral",
...
class TestLogisticsAgent:
    ...
    def test_logistics_all_ngos_exhausted(self):
        ...
        state = {
            "matched_ngos": [{"ngo_id": 1, "ngo_name": "NGO One", "reliability_score": 80}],
            "current_ngo_index": 5,
            "escalation_count": 3,
            "max_escalations": 3,
            "claim_sent": False,
    ...
    def test_logistics_accepts_claim(self, mock_random):
        ...
        state = {
            "matched_ngos": [{"ngo_id": 1, "ngo_name": "NGO One", "reliability_score": 90}],
            "current_ngo_index": 0,
            "escalation_count": 0,
            "max_escalations": 3,
            "claim_sent": False,
    ...
    def test_logistics_max_escalations(self, mock_random):
        ...
        state = {
            "matched_ngos": [{"ngo_id": 1, "ngo_name": "NGO One", "reliability_score": 50}],
            "current_ngo_index": 0,
            "escalation_count": 2,
            "max_escalations": 3,
            "claim_sent": False,
